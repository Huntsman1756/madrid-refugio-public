...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Madrid Refugio | Motor de Simulación Climática Urbana",
    description: "Protegiendo a 430.000 mayores del calor extremo con rutas de sombra calculadas en tiempo real. 490.000 polígonos LiDAR · 661.000 árboles · 13 franjas horarias.",
    type: "website",
    locale: "es_ES",

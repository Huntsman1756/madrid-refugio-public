      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mb-24 stagger-children">
          {[
            ...
            { icon: TreePine, label: "Arbolado detallado", detail: "Ficha oficial del dataset municipal", color: "#16a34a", href: "https://datos.madrid.es/sites/v/index.jsp?vgnextoid=4d629f43d3b5f010VgnVCM1000009b25680aRCRD&vgnextchannel=374512b9ace9f010VgnVCM1000009b25680aRCRD" },
            { icon: Users, label: "Padron municipal historico", detail: "Ficha oficial del dataset municipal", color: "#de1d8d", href: "https://datos.madrid.es/sites/v/index.jsp?vgnextoid=3222b33a98d5f010VgnVCM1000009b25680aRCRD&vgnextchannel=374512b9ace9f010VgnVCM1000009b25680aRCRD" },
            { icon: Wind, label: "Calidad del aire", detail: "Ficha oficial del dataset municipal", color: "#f97316", href: "https://datos.madrid.es/sites/v/index.jsp?vgnextoid=26b6a79eb3d5f010VgnVCM1000009b25680aRCRD&vgnextchannel=374512b9ace9f010VgnVCM1000009b25680aRCRD" },
            { icon: Database, label: "Estaciones de aire", detail: "Ficha oficial del dataset municipal", color: "#7c3aed", href: "https://datos.madrid.es/sites/v/index.jsp?vgnextoid=f41a40149d46a610VgnVCM1000001d4a900aRCRD&vgnextchannel=374512b9ace9f010VgnVCM1000009b25680aRCRD" },
            { icon: Droplets, label: "Fuentes de agua para beber", detail: "Ficha oficial del dataset municipal", color: "#0ea5e9", href: "https://datos.madrid.es/sites/v/index.jsp?vgnextoid=9986726b4c95d410VgnVCM1000000b205a0aRCRD&vgnextchannel=374512b9ace9f010VgnVCM1000009b25680aRCRD" },
            { icon: Landmark, label: "Bibliotecas municipales", detail: "Ficha oficial del dataset municipal", color: "#8b5cf6", href: "https://datos.madrid.es/sites/v/index.jsp?vgnextoid=fa835afff6a6a510VgnVCM1000001d4a900aRCRD&vgnextchannel=374512b9ace9f010VgnVCM1000009b25680aRCRD" },
            { icon: Landmark, label: "Centros culturales", detail: "Ficha oficial del dataset municipal", color: "#6d28d9", href: "https://datos.madrid.es/sites/v/index.jsp?vgnextoid=6838331c966c7710VgnVCM1000001d4a900aRCRD&vgnextchannel=374512b9ace9f010VgnVCM1000009b25680aRCRD" },
            { icon: Landmark, label: "Polideportivos municipales", detail: "Ficha oficial del dataset municipal", color: "#9333ea", href: "https://datos.madrid.es/sites/v/index.jsp?vgnextoid=8a9b180f9f56a610VgnVCM1000001d4a900aRCRD&vgnextchannel=374512b9ace9f010VgnVCM1000009b25680aRCRD" },
